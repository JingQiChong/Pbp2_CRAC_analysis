...
This directory contains genome sequences, annotations, aligner index and gene lists used to process and analyse Pbp2 CRAC data.
...
## Pbp2_TargetGeneNameOnly.txt

The names of select Pbp2 target genes, that are used as input for detailed pileup maps in `pyPileup.py` of the nf_CRACpipeline.
